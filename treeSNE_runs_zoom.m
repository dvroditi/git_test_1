...
original_saveStem = 'prostate_run_split_large'; %Save stem from first treeSNE_runs

treeSNE_parameters.saveStem					= [original_saveStem '_zoom_cl8_all'];

outDir										=['/Users/delaura/Documents/MATLAB/Code/treeSNE/PC/' original_saveStem '/']; % Directory to outpout results
...
treeSNE_parameters.used_markers				= [{'CD10'}, {'CD107a'}, {'CD193'}, {'CD20'}, {'CD3'}, {'CD33'}, {'CD44'}, {'CD45'}, {'CD61'}, {'CD68'}, {'CD71'}, {'CD82'}, {'CD90'}, {'E-cadherin'},{'CAH9'}, {'CK6'}, {'Cleaved Cas3'}, {'CXCR4'}, {'ER'}, {'FAP'}, {'Her2'}, {'KI-67'}, {'pAkt'}, {'pErk1/2'}, {'pNFkB'}, {'pPlcg2'}, {'pRb'}, {'pS6'}, {'pSTAT5'}, {'VEGFR2'}]';
...
treeSNE_parameters.nRuns					= 20; % # cluster runs for the same initial set of reference cells; to be averaged later
...
treeSNE_zoom(treeSNE_parameters);
