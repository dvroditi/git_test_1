function [] = treeSNE_robust_distance_aggregator_zoom(treeSNE_parameters)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    % This section is where treeSNE_zoom differs from original
    % treeSNE_robust_distance_aggregator
    % --------------------------------------------------------
